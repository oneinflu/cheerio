                ...
                return (
                  <li
                    ...
                    className={cn(
                      ...
                      isSelected ? "bg-pink-50 border-l-4 border-pink-600" : "hover:bg-slate-100"
                    )}
        ...
        {selectedId ? (
          ...
          <div className="flex h-full items-center justify-center bg-slate-50 text-slate-500">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-slate-700 mb-1">Select Instagram Conversation</h3>
